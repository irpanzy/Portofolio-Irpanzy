...
export const experienceData = [
  {
    ...
    responsibilities: [
      ...
      "Implemented secure starter control and activation workflows with PIN verification.",
      "Developed advanced report export features, including summary and detailed reports with dynamic filename generation.",
      "Integrated RESTful API endpoints for vehicles, users, and activity reports.",
      "Improved UX through toast notifications, refined table interactions, and consistent UI styling.",
      "Replaced mock data with live API integrations to ensure accurate real-time data display.",
      "Conducted major refactoring to enhance maintainability, remove unused elements, and streamline edit operations.",
    ],
  },
  {
